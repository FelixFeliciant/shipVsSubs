...
public class Game {
    ...
    // Enemy Submarine.
    private ArrayList<Submarine> enemySubmarineList = new ArrayList<>();
   ...
   /**
	...
	random = new Random();
        ...
        enemySubmarineList = new ArrayList<>();
    ...
    public void Draw(Graphics2D g2d, Point mousePosition, long gameTime)
    {
        ...
        for (Submarine submarine : enemySubmarineList) {
            submarine.draw(g2d);
        }
        
        // Draws all the enemy rockets. 
        for (EnemyRocket enemyRocket : enemyrocketList) {
            enemyRocket.draw(g2d);
        }
        ...
        for (RocketSmoke rocketSmoke : rocketSmokeList) {
            rocketSmoke.Draw(g2d);
        }
        
        // Draw all explosions.
        for (Animation animation : explosionsList) {
            animation.Draw(g2d);
        }
...
/*
   ...
   */
   ...
   {
       for (Submarine eh : enemySubmarineList) {
